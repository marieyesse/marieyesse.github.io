...
```{r roadmaps, results=TRUE, message=FALSE, warning=FALSE, echo=FALSE, fig.align="center", fig.width=10, fig.height=6, fig.cap="_**Figure**: Timeline of published roadmaps and scenario studies on industry decarbonization per industry"}
...
```{r roadmaps_field, results=TRUE, message=FALSE, warning=FALSE, echo=FALSE, fig.align="center", fig.width=12, fig.height=7, fig.cap="_**Figure**: Timeline of published roadmaps and scenario studies on industry decarbonization per pusblishing field"}
...
[](https://github.com/marieyesse/marieyesse.github.io/blob/master/img/Word_Network_PDFCorpus_roadmaps_.png?raw=true) 
