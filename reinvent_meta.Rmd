...
```{r roadmaps_field, results=TRUE, message=FALSE, warning=FALSE, echo=FALSE, fig.align="center", fig.width=12, fig.height=5, fig.cap="_**Figure**: Timeline of published roadmaps and scenario studies on industry decarbonization per pusblishing field"}
