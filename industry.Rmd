...
```{r results=TRUE, message=FALSE, warning=FALSE, echo=FALSE,WISEECO2, fig.align="center", fig.width=8, fig.height=4, fig.cap="_**Figure**: Investments for the short-term (2015-2030), mid-term (2030-2040), and long-term (2040-2050)_"}
...
INDUSCAPCHANGEinvest=ggplot() +
  ...
  scale_fill_manual(values=c('#2ca25f','blue', 'darkgrey'),
                    breaks=c("Shortterm", "Midterm", "Longterm"),
                    labels=c("2015-2030", "2030-2040", "2040-2050"))  +
