...
## PRODUCTVOLUME
PRODVOLTAB=ALLVAR[Variable %in% c("Production|Industry|Chemical|HVC|Total Demand",
...
INDICATORSminmax = INDICATORSminmax %>% mutate(
                          Sector=
                            fct_relevel(Sector, "Iron and Steel", "Chemicals and Petrochemicals", "Pulp and Paper", "Food Processing")
                            )
