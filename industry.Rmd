...
MINMAX2050=ggplot()+
  ...
  annotate("text", x=1,y=104, label="Net negative", size=3, angle=90, colour="dimgrey", hjust=0) +
  annotate("text", x=1, y=35, label="Reductions", size=3, angle=90, colour="dimgrey",  hjust=0) +
  annotate("text", x=1, y=-5, label="Increase", size=3, angle=90, colour="dimgrey",  hjust=1) +
  geom_crossbar(data=CO2REDTABminmax[RED=="RED2050"], aes(x=Sector, ymin=ymin, ymax=ymax, y=ymax, fill=Model, colour=Model),  width=.7, position=position_dodge(width=0.7))+
...
```{r results=TRUE, message=FALSE, warning=FALSE, echo=FALSE,WISEECO2, fig.align="center", fig.width=8, fig.height=4, fig.cap="_**Figure**: Capacity changes (Mt/yr) for the short-term (2015-2030), mid-term (2030-2040), and long-term (2040-2050)_"}
...
INDUSCAPCHANGEaggr=ggplot() +
  ...
  labs(y="Capacity change (Mt/yr)", x = "Year") +
  guides(fill=guide_legend("Sector"))+
